...
class Cart extends Component {
    constructor(props){
        super(props);
        this.state = {
                hotels : [{name:'MOETS CURRY LEAF', amount:5.98,dishes:[{url: require('../images/menu/imgmenu1.png'), name:'Noodle Soup', des:'Boiled noodle serverd in a pot with broth', quantity:1, rate:2.99}, {url: require('../images/menu/imgmenu1.png'), name:'Noodle Soup', des:'Boiled noodle serverd in a pot with broth', quantity:1, rate:2.99}] }, {name:'CAFE 5H BY THE KITCHEN', amount:16.49,dishes:[{url: require('../images/menu/imgmenu11.png'), name:'Veg Mixed Fried Rice', des:'Boiled noodle serverd in a pot with broth', quantity:1, rate:10.50}, {url: require('../images/menu/imgmenu9.png'), name:'Paneer Tikka', des:'Boiled noodle serverd in a pot with broth', quantity:1, rate:5.99}] } ],
